                            ...
                            <Grid.Row>
                                <Grid.Column computer={7} mobile={16}>
                                    <h1 style={{ color: darkMode ? "#ffffff" : null }}>
                                        Interested in our services or need advice? Get in touch and we'll be glad to help.
                                    </h1>
                                </Grid.Column>
                            </Grid.Row>
                        </Grid>
              ...
              >
                <Container>
                    ...
                    style={{
                      ...
                      >
                        <h2 style={{color: darkMode ? '#ffffff' : null}}>You can find us here</h2>
                      </Header>
                      <Grid centered>
                          <Grid.Row>
                              {locationData && locationData.length && locationData.map((data, i) => {
                                  return (
                                      <Grid.Column computer={4} mobile={16}>
                                          <LocationSegment key={i} data={data} darkMode={darkMode} />
                                      </Grid.Column>
                                  )
                              })}
                          </Grid.Row>
