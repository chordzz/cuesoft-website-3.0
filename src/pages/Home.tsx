...
export const Home = () => {
  return (
    <div>
      ...
      <section id="hero" className="flex items-center min-h-full">
        <div className="flex my-container flex-col md:flex-row mb-12">
          <div className="md:w-3/4 md:pt-28">
            ...
            <h1 className="md:mt-4 text-textNormalSupLight text-[28px] md:text-6xl text-left font-bold">
              Modernizing{" "}
              <span className="text-brightRedLight">Businesses</span>
            </h1>

            <p className="text-textNormalSupLight text-left mt-6 md:mt-9 text-[12px] md:text-2xl md:max-w-2xl">
          ...
          <div className="right-item mt-4 md:mt-0">
            <img
              src={HeroImg}
              alt="Hero"
              className="w-[400px] h-[320px] md:w-[600px] md:h-[550px]"
            />
          </div>
        </div>
      </section>
      ...
      <section
        id="clients"
        className="flex items-center bg-bgLight h-20 md:h-36"
      >
        ...
        <div className="my-container flex justify-around items-center min-h-full">
          <div>
            <img
              src={Unilever}
              alt="Unilever"
              className="w-[60px] h-[30px] md:w-[150px] md:h-[90px]"
            />
          </div>
      ...
      >
        <div className="my-container text-center">
          <h3 className="text-brightRed text-[20px] md:text-3xl font-bold md:mb-8">
            How Cuesoft Does It
          </h3>
          <div className="flex text-center flex-col flex-wrap md:flex-row md:flex-nowrap md:gap-x-16 justify-between">
            <div className="relative md:w-1/4">
              <img src={Plan} alt="Plan" />
              <h5 className="text-[15px] md:text-xl text-brightRed font-bold">
                Plan
              </h5>
              <p className="max-w-sm md:max-w-xs text-sm text-textNormal">
      ...
      <section id="why" className="flex items-center">
        <div className="my-container text-center py-20">
          <h3 className="text-brightRed text-[20px] md:text-3xl font-bold mb-20">
            Why Cuesoft
          </h3>
          <div className="flex flex-col md:flex-row justify-around flex-wrap gap-y-24">
            <div className="relative">
              <div className="border-brightBlue rounded-3xl max-w-lg border p-8 py-12 pr-20 text-left relative overflow-hidden">
                <h3 className="text-brightBlue text-[12px] md:text-xl mb-4 font-bold">
                  Go From An Idea To A Published Site
                </h3>

                <p className="text-[10px] md:text-lg text-textNormal">
            ...
            <div className="relative">
              <div className="rounded-3xl max-w-lg border border-brightPurple p-8 py-12 pr-20 text-left relative overflow-hidden">
                <h3 className="text-brightPurple text-[12px] md:text-xl mb-4 font-bold">
            ...
            <div className="relative">
              <div className="rounded-3xl max-w-lg border border-brightPurpleLight p-8 py-12 pr-20 text-left relative overflow-hidden">
                <h3 className="text-brightPurpleLight text-[12px] md:text-xl mb-4 font-bold">
            ...
            <div className="relative">
              <div className="rounded-3xl max-w-lg border border-brightBrown p-8 py-12 pr-20 text-left relative overflow-hidden">
                <h3 className="text-brightBrown text-[12px] md:text-xl mb-4 font-bold">
      ...
      >
        <div className="my-container text-center py-14">
          <h3 className="text-brightRed text-[20px] md:text-4xl font-bold mb-12">
            Our Tools
          </h3>
          ...
          <div className="">
            ...
            <div className="flex flex-col md:flex-row justify-around">
              <div>
                <h4 className="text-textNormal text-[15px] md:text-xl mb-8 ">
              ...
              <div>
                <h4 className="text-textNormal text-[15px] md:text-xl mt-12 mb-8 md:mt-0">
                  Backend Development
                </h4>
      ...
      >
        <div className="my-container py-20">
          <h3 className="text-brightRed text-[20px] md:text-4xl font-bold mb-12 text-center md:text-left">
            Our Services
          </h3>
          ...
          <div className="flex flex-col md:flex-row justify-around gap-6">
            <div className="bg-white shadow-sm card relative">
              <div className="flex pb-4 gap-2 md:gap-0">
                ...
                <div className="w-2/3">
                  <h4 className="text-[15px] md:text-xl text-brightRedLight mb-2 md:mb-6 ">
            ...
            <div className="bg-white shadow-sm card">
              ...
              <div className="absolute bottom-5 right-5">
                <img
                  src={ChevronRight}
                  alt="Chevron Right"
                  className="hover:fill-current hover:text-brightRed"
                />
              </div>
            </div>
          </div>
      ...
      <section id="reviews" className="flex items-center md:min-h-screen">
        <div className="my-container text-center">
          <div className="relative">
            <h3 className="text-brightRed text-[18px] md:text-4xl font-bold mt-16 mb-8">
            ...
            <div className="bg-bgLightCard shadow-sm justify-center relative p-8 rounded overflow-hidden md:w-1/2 text-textDarkBlue">
              ...
              <div className="flex gap-4 items-center mt-4">
                ...
                <div className="text-left">
                  <h4 className="font-bold  text-[13px] md:text-lg">
                    Ayodele Joseph
                  </h4>
